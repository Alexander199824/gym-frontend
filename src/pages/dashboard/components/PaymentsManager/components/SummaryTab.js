...
import { 
  ...
  Calendar, Activity, Banknote, BarChart3, ChevronDown, ChevronUp
} from 'lucide-react';
...
const SummaryTab = ({ 
  ...
  // Estado para secciones expandibles en móvil
  ...
  const getTrendIcon = (direction) => {
    switch (direction) {
      ...
      default:
        return <Activity className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600" />;
    }
  };
  ...
  // Componente para header de sección expandible
  const SectionHeader = ({ title, icon: Icon, isExpanded, onToggle, children }) => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      <button
        onClick={onToggle}
        className="w-full p-4 flex items-center justify-between text-left hover:bg-gray-50 transition-colors sm:cursor-default sm:pointer-events-none"
      >
        <h4 className="text-base sm:text-lg font-medium text-gray-900 flex items-center">
          <Icon className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
          {title}
        </h4>
        <ChevronDown className={`w-5 h-5 text-gray-400 transition-transform sm:hidden ${
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Métricas principales - SEMPRE VISIBLE */}
      <SectionHeader
        title="Métricas Principales"
        icon={BarChart3}
        isExpanded={expandedSections.mainMetrics}
        onToggle={() => toggleSection('mainMetrics')}
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center">
                <Bird className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 flex-shrink-0" />
                <div className="ml-3 min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-green-600">Ingresos Totales</div>
                  {trends.monthlyTrend && (
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-3 min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-blue-600">Transacciones</div>
            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-3 min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-orange-600">Promedio</div>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-purple-100 border border-purple-200 rounded-lg p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-3 min-w-0">
                  ...
                  <div className="text-xs sm:text-sm text-purple-600">Tasa de Éxito</div>
        ...
        <div className="p-4 pt-0">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
              <Banknote className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 mx-auto mb-2" />
              <div className="text-xl sm:text-2xl font-bold text-green-900">
                {paymentMethods.cash}
              </div>
              <div className="text-xs sm:text-sm text-green-600">Efectivo</div>
            </div>
            ...
            <div className="text-center p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="text-xs sm:text-sm text-blue-600">Tarjeta</div>
            </div>
            
            {/* Transferencia */}
            <div className="text-center p-4 bg-purple-50 rounded-lg border border-purple-200">
              <Building className="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 mx-auto mb-2" />
              <div className="text-xl sm:text-2xl font-bold text-purple-900">
                {paymentMethods.transfer}
              </div>
              <div className="text-xs sm:text-sm text-purple-600">Transferencia</div>
            </div>
            
            {/* Móvil */}
            <div className="text-center p-4 bg-orange-50 rounded-lg border border-orange-200">
              <Activity className="w-6 h-6 sm:w-8 sm:h-8 text-orange-600 mx-auto mb-2" />
              <div className="text-xl sm:text-2xl font-bold text-orange-900">
                {paymentMethods.mobile}
              </div>
              <div className="text-xs sm:text-sm text-orange-600">Móvil</div>
            </div>
          </div>
        </div>
      </SectionHeader>
      ...
      <SectionHeader
        ...
        icon={Calendar}
        isExpanded={expandedSections.periods}
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-green-600 truncate ml-2">
        ...
        <div className="p-4 pt-0">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="text-center p-4">
              ...
              <div className="text-xs sm:text-sm text-gray-600">Tasa de Conversión</div>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <div className="text-xs sm:text-sm text-gray-600">Tiempo Procesamiento</div>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <div className="text-xs sm:text-sm text-gray-600">Transacciones Fallidas</div>
            </div>
          </div>
        </div>
      </SectionHeader>
      ...
      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
        ...
        {/* Nota sobre navegación móvil */}
        <div className="mt-2 text-xs text-center text-gray-500 italic sm:hidden">
          Toca las secciones para expandir/contraer la información
        </div>
      </div>
    </div>
  );
